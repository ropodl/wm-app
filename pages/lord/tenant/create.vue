  ...
  <v-form ref="formRef" @submit.prevent="submit">
    <v-container>
      ...
      <v-col cols="12" md="8">
            ...
            <lazy-common-shared-field-label>Tenant's Sub Domain name</lazy-common-shared-field-label>
            <v-text-field v-model="form.sub"></v-text-field>
            <lazy-common-shared-field-label>Tenant's Primary Email Address</lazy-common-shared-field-label>
