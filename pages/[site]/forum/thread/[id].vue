      ...
      <v-col cols="12">
        {{comments}}
          ...
          <v-list border flat rounded="lg">
            <v-list-item prepend-avatar="https://images.unsplash.com/photo-1645378198905-bca326a21167?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" title="Saroj Poudel" :subtitle="content" />
          </v-list>
        </template>
      </v-col>
      </v-row>
